...
import { IPatientMeta } from '@/types/meta.type';
import {
    Box,
    Card,
    CardContent,
...
const PatientDashboardPage = () => {
    ...
    const statCards = [
        ...
        },
        {
            ...
            value: meta.prescriptionCount || 0,
